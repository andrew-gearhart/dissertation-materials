...
# x-axis min is 6, y-axis goes from 0-4.e7

# if p > 75, use x-data from col one. if MT(p,t) ($5) is < UB ($3) and > LB ($2), use that value as y-data
